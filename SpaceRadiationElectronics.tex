...
\begin{document}
    ...
    \begin{frame}<handout:0>[plain, noframenumbering]
      ...
      \only<2>{\includegraphics[height=\textheight]{Delta_Rocket_Telstar1_upscayl_2x_ultramix-balanced-4x.png}\\
      ...
      \only<3>{\includegraphics[height=\textheight]{Telstar1_upscayl_4x_ultramix-balanced-4x.png}\\
