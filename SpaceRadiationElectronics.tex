...
\begin{document}
    ...
    \begin{frame}<handout:0>[plain, noframenumbering]
      ...
      \only<3>{\includegraphics[height=\textheight]{Delta_Rocket_Telstar1_upscayl_2x_ultramix-balanced-4x.png}\\
      ...
      \only<4>{\includegraphics[height=\textheight]{Telstar1_upscayl_4x_ultramix-balanced-4x.png}\\
 ...
 % Keine automatischen Abschnittsseiten erwünscht
    ...
    \begin{frame}[plain]{Gliederung}
      \vspace{0.3cm}
      \tableofcontents
      \setcounter{page}{1} % Seitenzähler auf 1 setzen nach Inhaltsfolie
    \end{frame}

    % Frame 2: Einordnung der Strahlungseffekte
    \section{Grundlagen der Strahlungseffekte}
    \subsection{Einordnung der Strahlungseffekte}
    ...
    \begin{frame}{Strahlendosen im Vergleich}
      \begin{figure}
        \centering
        \includegraphics[height=\textheight]{RadEnv.png}\\[-3mm]
    ...
    \subsection{Strahlungsquellen im Weltraum}
    ...
    \subsection{Van-Allen-Gürtel \& SAA als TID-Hotspots}
    ...
    \section{TID-Mechanismus}
    \subsection{MOS-Querschnitt \& Grundprinzip der Ionisation}
    ...
    \subsection{Gesamtwirkung im MOSFET}
    ...
    \section{Tests \& Qualifikation}
    \subsection{TID-Härtungstests und Qualifikationsverfahren (RHA)}
    ...
    \begin{frame}{TID-Testquellen \& Randbedingungen}
      \textbf{Strahlungsquellen:}
      \begin{itemize}
    ...
    \begin{frame}{Dosisrate, ELDRS \& Testablauf}
      \textbf{Dosisrate:}
      \begin{itemize}
    ...
    \begin{frame}{Kernaussagen}
      \begin{columns}[T,totalwidth=\textwidth]
        \begin{column}{0.55\textwidth}
          ...
          \begin{itemize}
            \item \textbf{TID} = kumulative Ionisationsschäden \linebreak in Oxiden \& Grenzflächen
 ...
 % Q&A Folie
   \begin{frame}<handout:0>[noframenumbering]{Q \& A}
